...
//Gravity
//
float3 GetGravity(float3 position, float3 direction, float gravitationalConstant, float mass )
{
    ...
    out float3 nDir  )
{
    ...
    for(int i = 0; i < MAX_STEPS; i++)
    {
        ...
        position += GetGravity(position,direction, gravitationalConstant, mass) * STEP_SIZE;
